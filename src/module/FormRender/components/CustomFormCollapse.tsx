...
export const CustomFormCollapse: ComposedFormCollapse = observer(
  ({ formCollapse, ...props }) => {
...
CustomFormCollapse.CollapsePanel = CollapsePanel
CustomFormCollapse.createFormCollapse = createFormCollapse

export default CustomFormCollapse
